...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <meta name="description" content="Конференції Навчально-методичний центр забезпечення якості вищої освіти" />
    <meta name="keywords" content="Конференції Навчально-методичний, центр, забезпечення, якості, вищої, освіти, ОНАХТ" />
  ...
  <body>
    <div class="container-fluid" style="background-color: rgb(251, 244, 225)">
      @include('college.layout._head')
      <div class="row m-1"></div>
      @include('college.layout._menu')
    </div>
    <div class="container" >
      @yield('content')
    </div>
