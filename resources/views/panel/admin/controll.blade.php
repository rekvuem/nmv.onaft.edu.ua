@extends('panel.layout.index')@section('title','Керування сайтом')
@section('page_styles')
@endsection
@section('page_script')
    <script>
...
@section('content')
    ...
    <div class="col-md-12">
        <div class="row collapse" id="collapse-form">
            <a href="№" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add_modal">
                <li class="icon-user-plus icon-1x"></li>
                Додати</a>
        </div>
