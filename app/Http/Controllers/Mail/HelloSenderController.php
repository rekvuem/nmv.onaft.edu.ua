...
//  public function SendEmailAccept($email, $pass) {  
//    define('HOSTNAME_API', '3dtour.onaft.edu.ua'); // Host name REST API
//    define('KEY_API', 'Ezn3lFoeTthLXCVlFdHAKalt3AaI34lAk7CYAU9'); // REST API key индивидуальный
//// Формируем сообщение в формате HTML
//    $message   = "<html><head></head>";
//    $message   .= " <body>";
...
//      }
//    }
//    return redirect()->view('spanel.admin.users.index');
//  }
